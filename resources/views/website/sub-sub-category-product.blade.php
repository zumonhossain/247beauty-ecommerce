                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link shop-page-tab-link active" id="home-tab" data-toggle="tab"
                                    href="#home" role="tab" aria-controls="home" aria-selected="true"><i
                                        class="icon fa fa-th-large"></i> Grid</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link shop-page-tab-link" id="profile-tab" data-toggle="tab" href="#profile"
                                            ...
                                            <div class="single-shop-product">
                                                ...
                                                <div class="shop-content text-center">
                                                    ...
                                                    <div class="product-price">
                                                        @if ($product->discount_price == null)
                                                            <span
                                                                class="best-seller-main-price">{{ $product->selling_price }} TK</span>
                                                        @else
                                                            <span
                                                                class="best-seller-main-price">{{ $product->discount_price }} TK</span>
                                                            <span
                                                                class="best-seller-discount-price">{{ $product->selling_price }} TK</span>
                                                        @endif
                                                    </div>
                                                    <div class="shop-cart-list mt-2">
                                                        <button class="category-cart-btn" type="button" title="Add Cart"
                                                            data-toggle="modal" data-target="#cartModal"
                                                            id="{{ $product->id }}" onclick="productView(this.id)">
                                                            <i class="fa fa-shopping-cart"></i>
                                                        </button>

                                                        <button class="category-cart-btn" type="button"
