    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('update_social') }}" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="mdi mdi-twitter"></i></span>
