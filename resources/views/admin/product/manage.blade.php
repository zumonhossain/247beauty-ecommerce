                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($product->product_status == 1)
                                                <a href="{{ url('admin/product-inactive/'.$product->product_slug) }}" class="btn btn-sm btn-danger down-icon" title="inactive"> <i class="fa fa-arrow-down"></i></a>
                                            @else
                                                <a href="{{ url('admin/product-active/'.$product->product_slug) }}" class="btn btn-sm btn-success up-icon" title="active now data"> <i class="fa fa-arrow-up"></i></a>
                                            @endif
