...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-success">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> Add Promotional Banner Two </h4>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('promotional.banner.two.insert') }}" id="myForm" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-lg-12">
            <div class="card card-outline-success">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> All Promotional Banner Two</h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach($banner as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-success view-icon" href="{{ url('admin/promotional/banner/two/view/'.$item->ban_slug) }}"><i class="mdi mdi-library-plus"></i></a>
                                        <a class="btn-warning edit-icon" href="{{ url('admin/promotional/banner/two/edit/'.$item->ban_slug) }}"><i class="mdi mdi-table-edit"></i></a>
    ...
    <div id="softDelModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="{{ route('promotional.banner.two.softdelete') }}">
                @csrf
