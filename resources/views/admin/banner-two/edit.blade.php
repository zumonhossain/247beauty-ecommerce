        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i>Promotional Banner Two Update</h4>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('promotional.banner.two.update') }}" id="myForm" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
