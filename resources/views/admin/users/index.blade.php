                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center">
                            <span style="color: #ffffff">Total Users</span> <span class="badge bg-white text-danger">{{ count($users) }}</span>
                            <span style="color: #ffffff">and Active Users</span> <span class="badge bg-white text-danger">{{ $online_user }} </span>
                        </div>
                    </div>
                </div>
                <div class="card-body">
