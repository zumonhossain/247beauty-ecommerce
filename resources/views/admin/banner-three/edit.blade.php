        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i>Promotional Banner Three Update</h4>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('promotional.banner.three.update') }}" id="myForm" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-sm-12">
                                <div class="text-center">
                                    <button type="submit" class="btn btn-dark registration-btn">Update Promotional Banner</button>
                                </div>
                            </div>
                        </div>
                    </form>
