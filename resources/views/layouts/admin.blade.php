...
<body class="fix-header fix-sidebar card-no-border">
    <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{ route('contactinformation') }}">Contact Information</a></li>
                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Banner</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ route('banner') }}">Main Banner</a></li>
                                <li><a href="{{ route('promotional.banner.two') }}">Promotional Banner Two</a></li>
                                <li><a href="{{ route('promotional.banner.three') }}">Promotional Banner Three</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a class="waves-effect waves-dark" href="{{ route('sponsor') }}" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Sponsor</span></a>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <!-- ==============================Footer Start ================================ -->
            <footer class="footer"> © 2022247beauty </footer>
            <!-- ============================Footer End================================== -->
